...
def main():
    ...
    if hitung_roi:
        ...
        with st.spinner("⏳ Menghitung ROI dan menyiapkan laporan..."):
            ...
            if not creds:
                st.warning("Kredensial Google tidak valid. Sinkronisasi dilewati.", icon="🔒")
            elif pdf_content:
                ...
                if gc:
                    with st.spinner("Menyimpan data ke Google Sheet..."):
                        ...
                        if google_utils.append_to_sheet(gc, GOOGLE_SHEET_ID, GOOGLE_SHEET_NAME, HEADER_ROW, sheet_row):
